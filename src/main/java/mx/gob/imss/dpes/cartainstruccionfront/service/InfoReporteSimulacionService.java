 ...
 */
@Provider
public class InfoReporteSimulacionService extends ServiceDefinition<RequestCreacionCartaInstruccion, RequestCreacionCartaInstruccion> {
    ...
    public Message<RequestCreacionCartaInstruccion> execute(Message<RequestCreacionCartaInstruccion> request) throws BusinessException {
        ...
        log.log(Level.INFO, "Buscando el resumen de la Carta de Libranza simulacion: {0}", request.getPayload().getPrestamo().getSolicitud());
