 ...
 */
@Provider
public class GenerarReporteSimulacionService extends ServiceDefinition<RequestCreacionCartaInstruccion, RequestCreacionCartaInstruccion>{
    ...
    public Message<RequestCreacionCartaInstruccion> execute(Message<RequestCreacionCartaInstruccion> request) throws BusinessException {
        ...
        reporte.setRuta("/reports/CartaInstruccion.jasper");
        ...
        if (load.getStatus() == 200) {
            ...
            List<PrestamoRecuperacion> prestamosPorLiquidar = obtenerPrestamos(request.getPayload().getSolicitud().getId());
