 ...
 */
@Provider
public class GenerarReportePrestamoPromotor extends ServiceDefinition<CapacidadCreditoRequest, CapacidadCreditoRequest> {
    ...
    public Message<CapacidadCreditoRequest> execute(Message<CapacidadCreditoRequest> request) throws BusinessException {
        ...
        amortizacionInsumos.setCveSolicitud(request.getPayload().getPrestamo().getSolicitud());
